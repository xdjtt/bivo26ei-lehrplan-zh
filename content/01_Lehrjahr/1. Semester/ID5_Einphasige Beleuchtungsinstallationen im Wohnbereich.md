...
> [!example|titel] HS1:
> Sie erweitern im Wohnzimmer eines Einfamilienhauses die bestehende Installation. Im Einlasskasten fügen Sie eine zusätzliche Schaltmöglichkeit für eine geschaltete Steckdose hinzu (Sch 1). Zusätzlich wird die Installation um eine Rollladensteuerung (Sch 2) erweitert.

> [!example|titel] HS2:
> Bei der Neuinstallation einer Küche prüfen Sie, weshalb in der bisherigen Anlage die Sicherung bei gleichzeitiger Benutzung mehrerer Geräte ausgelöst hat. Sie planen die neuen Anschlüsse und erläutern dem Kunden, wie Überlastungen künftig vermieden werden können.
## Kenntnisse
